...
import com.app.unsplashgallery.Constants.Gallery.CACHE_SIZE_BYTES
import com.app.unsplashgallery.GalleryApplication
...
class GalleryModule {
    ...
    fun provideRetrofit(client: OkHttpClient): Retrofit {
        return Retrofit.Builder().baseUrl(Constants.Gallery.BASE_URL).client(client)
